...
void XYZtoLAB(const double &X, const double &Y, const double &Z, double &L, double &A, double &B); // convert CIE XYZ value to CIE LAB
void LABtoXYZ(const double &L, const double &A, const double &B, double &X, double &Y, double &Z); // convert CIE LAB value to CIE XYZ
...
void LABtoLCHab(const double &A, const double &B, double &C, double &H); // convert from LAB to LCH - L is the same so no need to convert
void LCHabToLAB(const double &H, const double &C, double &A, double &B); // convert from LCH to LAB - L is the same so no need to convert
...
const int wavelength_XYZ_start = 390;
const int wavelength_XYZ_nb = 441;
const double wavelength_XYZ[wavelength_XYZ_nb][4] = { // CIE 1931 2° CMF - 1nm step
